                    ...
                    <form action="{{ route('info.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea type="text" name="description" id="website__desc" class="form-control"
                                    placeholder="Codebumble Inc.">{{$websiteInformation['description']}}</textarea>
                            </div>
                ...
                <div class="row">
                    @if($websiteInformation['logo'])
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body">
                                    <img src="{{ \Storage::disk('primary_public')->url("/website_information/" . $websiteInformation['logo']) }}" alt="logo"
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                <img src="{{ \Storage::disk('primary_public')->url("/website_information/" . $websiteInformation['favicon']) }}" alt="favicon"
                                    class="w-100 h-100 object-fit-cover">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                <img src="{{ \Storage::disk('primary_public')->url("/website_information/" . $websiteInformation['thumbnail']) }}" alt="thumbnail"
                                    class="w-100 h-100 object-fit-cover">
                            </div>
                        </div>
                    </div>
